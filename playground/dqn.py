...
from gym_2048_n import gym_2048
import datetime
import pandas as pd
...
class DQN(nn.Module):
    def __init__(self, board_size):
        ...
        self.out = nn.Linear(in_features=64, out_features=4)  # 4 actions
...
policy_net = DQN(em.get_board_size()).to(device)
target_net = DQN(em.get_board_size()).to(device)
